...
const apiCanaryBlueprint = async function () {
        ...
        return new Promise((resolve, reject) => {
            ...
            res.on('end', () => {
                ...
                if (result[0]['active-status'] != 'active') {
                    throw `First validator status should be active. Validator: ${JSON.stringify(result[0])}`;
                }
   ...
   let stepConfig1 = {
    ...
    await synthetics.executeHttpStep('Verify hmyv2_getAllValidatorInformationByBlockNumber', requestOptionsStep1, validateSuccessful, stepConfig1);
